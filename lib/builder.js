...
SpriteSheetBuilder = (function() {
  ...
  function SpriteSheetBuilder(files, images, options) {
    ...
    this.outputDirectory = path.normalize(this.options.outputDirectory);
    separator = path.sep || "/";
  ...
  SpriteSheetBuilder.prototype.build = function(callback) {
    ...
    return this.layoutImages(function() {
      ...
      return async.series([_this.ensureDirectory(_this.outputImageDirectoryPath), _this.ensureDirectory(_this.outputStyleDirectoryPath), _this.style, _this.createSprite], function(err, results) {
  ...
  SpriteSheetBuilder.prototype.ensureDirectory = function(directory) {
    var _this = this;
    console.log("ensure dir " + directory);
