...
SpriteSheetConfiguration = (function() {
  function SpriteSheetConfiguration(files, options) {
    ...
    if (options.httpImagePath != null) {
      httpImgPath = options.httpImagePath;
      this.httpImagePath = httpImgPath.slice(-1) === "/" ? httpImgPath + options.outputImage : httpImgPath;
    }
    if (options.outputImage) {
      ...
      this.httpImagePath = this.httpImagePath || path.relative(this.outputStyleDirectoryPath, this.outputImageFilePath);
    }
